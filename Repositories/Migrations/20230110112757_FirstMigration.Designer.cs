...
namespace Repositories.Migrations
{
    ...
    [Migration("20230110112757_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repositories.Model.Address", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.BuildVersion", b =>
                {
                    ...
                    b.ToTable("BuildVersion", (string)null);
                });

            modelBuilder.Entity("Repositories.Model.Customer", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID");
            ...
            modelBuilder.Entity("Repositories.Model.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.Product", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Repositories.Model.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Repositories.Model.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID");
            ...
            modelBuilder.Entity("Repositories.Model.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Repositories.Model.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("Repositories.Model.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("Repositories.Model.CustomerAddress", b =>
                {
                    b.HasOne("Repositories.Model.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("Repositories.Model.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("Repositories.Model.Product", b =>
                {
                    b.HasOne("Repositories.Model.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Repositories.Model.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Repositories.Model.ProductCategory", b =>
                {
                    b.HasOne("Repositories.Model.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("Repositories.Model.ProductModelProductDescription", b =>
                {
                    b.HasOne("Repositories.Model.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("Repositories.Model.SalesOrderDetail", b =>
                {
                    b.HasOne("Repositories.Model.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("Repositories.Model.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("Repositories.Model.SalesOrderHeader", b =>
                {
                    b.HasOne("Repositories.Model.Address", "BillToAddress")
                    ...
                    b.HasOne("Repositories.Model.Address", "ShipToAddress")
